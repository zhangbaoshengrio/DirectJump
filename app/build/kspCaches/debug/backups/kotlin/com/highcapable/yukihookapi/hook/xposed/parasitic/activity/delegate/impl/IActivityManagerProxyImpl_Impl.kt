...
import com.highcapable.yukihookapi.hook.xposed.parasitic.activity.delegate.IActivityManagerProxy_com_wizpizz_directjump
...
object IActivityManagerProxyImpl_Impl {
    ...
    fun createWrapper(clazz: Class<*>?, instance: Any) = 
        Proxy.newProxyInstance(IActivityManagerProxyCaller.currentClassLoader, arrayOf(clazz), IActivityManagerProxy_com_wizpizz_directjump(instance))
}